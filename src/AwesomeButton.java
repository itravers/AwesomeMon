...
public class AwesomeButton extends JButton {
	 ...
	 * 
	 * @param startColor
	 *            The Untouched Color of the Button
	 * @param endColor
	 *            The End color of the button
	 * @param rollOverColor
	 *            The color of the button when rolled over
	 * @param pressedColor
	 *            The color of the button when pressed.
	 */
	public AwesomeButton(Color startColor, Color endColor, Color rollOverColor,
			Color pressedColor) {
		super();
	...
	public void paintComponent(Graphics g) {
		...
		if (!model.isEnabled()) {
			...
			setForeground(Color.WHITE);
			if (model.isRollover()) {
				GP = new GradientPaint(0, 0, rollOverColor, 0, h,
						rollOverColor, true);
			} else {
	...
	public static void main(String args[]) {
		...
		AwesomeButton standardButton = new AwesomeButton("Standard Button");
	...
	public JPanel getButtonsPanel() {
		...
		AwesomeButton rollOverButton = new AwesomeButton("RollOver Button");
		rollOverButton.setPreferredSize(new Dimension(130, 28));
		AwesomeButton disabledButton = new AwesomeButton("Disable Button");
		disabledButton.setPreferredSize(new Dimension(130, 28));
		disabledButton.setEnabled(false);
		AwesomeButton pressedButton = new AwesomeButton("Pressed Button");
